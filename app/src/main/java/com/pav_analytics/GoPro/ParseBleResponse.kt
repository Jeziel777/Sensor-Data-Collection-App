...
import com.pav_analytics.util.decodeToString
import com.pav_analytics.util.prettyJson
import com.pav_analytics.util.toHexString
import com.pav_analytics.util.toInt
import com.pav_analytics.util.toJsonElement
...
sealed class Response(val uuid: GoProUUID) {
    ...
    open class Tlv(uuid: GoProUUID) : Response(uuid) {
        ...
        override fun toString(): String =
            "ID: $id, Status: $status, Payload: ${payload.toHexString()}"
    }
