...
const val goProSettings =
    "To make the best of the resources and to obtain the most adequate data " +
            ...
            "a few seconds till the GPS is logged to start recording. As well to record videos no longer " +
            "than five minutes. \n" +
            " \n"+
            "According to GDPR compliance the camera should have the next angle for recording videos on public spaces"

const val phoneCameraInstructions =
    "According to GDPR compliance the camera should have the next angle for recording videos on public spaces"