...
fun initializeSensors(context: Context) {
    ...
    magnetometerSensor = MagnetometerSensor(context)
 ...
 */
fun embedSensorDataIntoVideo(
    videoFile: File,
    applicationContext: Context,
    currentTimeOfVideo: String
) {
    ...
    val tempOutputFile =
        File(videoFile.parentFile, "temp_PavAnalytics_Video_with_Sensors_${currentTimeOfVideo}.mp4")
