...
import com.pav_analytics.sensors.MeasurableSensor
...
import com.pav_analytics.util.recordVideo
import com.pav_analytics.util.takePhoto
            ...
            onTakePhotoClick = {
                takePhoto(
                    ...
                    capturedFileNameState = {
                        capturedFileName = it
                    }, // Pass lambda to set capturedFileName
            ...
            VisualDistressDialog(
                ...
                onVisualDistressSelected = { selectedVisualDistress ->
                    capturedFileName?.let { fileName ->
                        ...
                        Toast.makeText(
                            context,
                            "Photo saved with visual distress as: $selectedVisualDistress",
                            Toast.LENGTH_LONG
                        ).show()
                    }
                    showDialog = false
...
fun SensorInformation() {
    ...
    val sensorList = listOf(
        SensorData(
            ...
            accelerometerSensor.doesSensorExist
        ),
        ...
        SensorData(
            magnetometerSensor,
            remember { mutableStateOf("") },
            magnetometerSensor.doesSensorExist
        )
...
fun playShutterSound(context: Context) {
    val mediaPlayer = MediaPlayer.create(context, R.raw.camera_shutter_sound) // Add a sound file in res/raw
    mediaPlayer.start()
}