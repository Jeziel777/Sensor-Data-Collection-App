...
import com.example.pav_analytics.Content.appInstructions

import com.google.accompanist.systemuicontroller.rememberSystemUiController
import com.google.firebase.auth.FirebaseAuth

import com.example.pav_analytics.Content.goProSettings
import com.example.pav_analytics.Content.objectives
import com.example.pav_analytics.Content.phoneCameraInstructions
...
import com.example.pav_analytics.ui.components.HomeTitleCard
import com.example.pav_analytics.ui.theme.bluePavAnalytics
import com.example.pav_analytics.ui.theme.cyanBluePavAnalytics
...
fun InteractiveCard(
    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxHeight()) {
            Text(text = title, style = MaterialTheme.typography.headlineSmall, fontWeight = FontWeight.Bold, color = bluePavAnalytics)
            Text(text = description, style = MaterialTheme.typography.bodyLarge, color = Color.Black)
            Text(text = subtitle, style = MaterialTheme.typography.bodyLarge, fontWeight = FontWeight.Bold, color = Color.Black)
            Spacer(modifier = Modifier.height(8.dp))
