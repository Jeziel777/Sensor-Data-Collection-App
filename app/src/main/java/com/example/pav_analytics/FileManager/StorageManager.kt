...
fun getExternalStorageDirectory(context: Context): File {
    ...
    val externalDir = File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), "Pav-Analytics_Folder")
...
fun getCSVStorageDirectory(context: Context): File {
    val csvDirectory = File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), "Pav-Analytics_Folder/CSV_files")
...
fun getMediaStorageDirectory(context: Context): File {
    val mediaDirectory = File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), "Pav-Analytics_Folder/Media")
...
fun getZIPStorageDirectory(context: Context): File {
    val zipDirectory = File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), "Pav-Analytics_Folder/zip_files")
...
fun saveVideoToExternalStorage(context: Context, videoInputStream: InputStream, fileName: String): String? {
    val folder = getMediaStorageDirectory(context)
    val file = File(folder, fileName)
    ...
    return try {
        ...
        Log.i("FileSave", "File saved successfully: ${file.absolutePath}, size: ${file.length()} bytes")
        file.absolutePath
    } catch (e: IOException) {
...
@SuppressLint("NewApi")
fun saveFileToExternalStorage(context: Context, inputStream: InputStream, fileName: String): String? {
